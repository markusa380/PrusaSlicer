...
static std::vector<std::string> s_Preset_print_options {
    ...
    "wireframe_enabled", "wireframe_height", "wireframe_roof_inset", "wireframe_nozzle_clearance",
    "wireframe_nozzle_outer_diameter", "wireframe_nozzle_expansion_angle", "wireframe_flow_connection", "wireframe_flow_flat",
    "wireframe_printspeed_bottom", "wireframe_printspeed_up", "wireframe_printspeed_down", "wireframe_printspeed_flat",
    "wireframe_flat_delay", "wireframe_bottom_delay", "wireframe_top_delay", "wireframe_up_half_speed", "wireframe_top_jump",
    "wireframe_fall_down", "wireframe_drag_along", "wireframe_strategy", "wireframe_straight_before_down",
    "wireframe_roof_fall_down", "wireframe_roof_drag_along", "wireframe_roof_outer_delay",
    "wipe_tower",
